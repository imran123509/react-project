  ...
  return (
    ...
    <div className='body'>
      ...
      <div style={{backgroundColor:"white"}}>
        ...
        <div style={{display: "flex", justifyContent:"space-between", marginLeft:"2rem", marginRight:"14rem" }}>
        ...
        <div style={{backgroundColor:"white", borderWidth:"1px", borderStyle:"solid", width:"25rem", borderRadius:"10px", marginLeft:"2.2rem", marginTop:"2.5rem"}}>
             <div style={{fontSize:"2rem", marginTop:"1rem", marginLeft:"10px"}}>Location</div>
          <div style={{padding:"8px 8px 8px 8px"}}><img style={{width:"380px", height:"190px", borderRadius:"5px"}} src={Map}></img></div>
          <div style={{textAlign:"center"}}><p>Click on the maps to see location</p></div>
          </div>

          </div> 
           <div className='review' style={{backgroundColor:"white", borderWidth:"1px", borderStyle:"solid", width:"25rem", borderRadius:"10px", marginLeft:"2.2rem", marginTop:"1.5rem"}}>
              <div style={{fontSize:"2rem", marginTop:"1rem", marginLeft:"10px"}}>Reviews</div>
              ...
              <div style={{backgroundColor:"white", borderWidth:"0.5px", borderStyle:"solid", borderRadius:"10px"} }>
               <div><img src={Manimage}></img>Caron</div>
                <div style={{display:"flex"}}>
                <p>Great location, beautiful surrounding atmosphere, great staff. Most friendly and helpful......</p><p style={{color:"#FF6600", marginTop:"4rem", marginRight:"4.1rem"}}>More</p></div>
              </div>
              </div>
             
           </div>
          </div>
          <div style={{width:"100%", marginTop:"2.5rem", borderRadius:"7px",borderStyle:"solid", borderWidth:"1px", marginLeft:"2rem"}}>
            

           <div style={{display:"flex", justifyContent:"space-between", marginLeft:"7rem", marginRight:"7rem" }}>
            <div>
           <div style={{fontSize:"1.8rem", fontFamily:"sans-serif"}}>Check-In date</div>
           <div style={{fontSize:"1.8rem", fontFamily:"sans-serif",backgroundColor:"#FFE1C3", marginTop:"12px", color:"#FF6803", justifyItems:"center", width:"16rem", height:"3rem", borderRadius:"10px"}}>Wed, 09 Dec 2023</div>

           </div>
           <div>
           <div style={{fontSize:"1.8rem", fontFamily:"sans-serif"}}>Check-In Time</div>
           <div style={{fontSize:"1.8rem", fontFamily:"sans-serif",backgroundColor:"#FFE1C3", marginTop:"12px", color:"#FF6803", justifyItems:"center",  height:"3rem",borderRadius:"10px"}}>2:00 PM</div>
           </div>
           <div>
           <div style={{fontSize:"1.8rem", fontFamily:"sans-serif"}}>Rooms</div>
           <div style={{fontSize:"1.8rem", fontFamily:"sans-serif",backgroundColor:"#FFE1C3", marginTop:"12px", color:"#FF6803", justifyItems:"center", height:"3rem",borderRadius:"10px"}}>Rooms</div>

           </div>
           <div>
           <div style={{fontSize:"1.8rem", fontFamily:"sans-serif"}}>Adults</div>
           <div style={{fontSize:"1.8rem", fontFamily:"sans-serif",backgroundColor:"#FFE1C3", marginTop:"12px", color:"#FF6803", justifyItems:"center", height:"3rem",borderRadius:"10px",borderRadius:"10px"}}>Adults</div>
           </div>
           <div>
           <div style={{fontSize:"1.8rem", fontFamily:"sans-serif"}}>Childrens</div>
           <div style={{fontSize:"1.8rem", fontFamily:"sans-serif",backgroundColor:"#FFE1C3", marginTop:"12px", color:"#FF6803", justifyItems:"center", height:"3rem",borderRadius:"10px"}}>Childrens</div>
           </div>
           
           </div>
              <div>
                <div style={{marginLeft:"6.5rem", fontSize:"1.5rem", marginTop:"1rem"}}>Select Your Slot</div>
              </div>
              <div>
                <div style={{marginLeft:"6.5rem", fontSize:"1.5rem", marginTop:"1rem", backgroundColor:"#FFE1C3", color:"#FF6600",borderWidth:"1px", borderStyle:"solid", borderRadius:"10px"}}>
              <input style={{width:"29px", height:"29px"}} type="radio" id="html" name="fav_language" value="HTML"/>
...
               <label for="html">Rs. 1288.00/-</label><br></br>
             ...
             <div style={{marginLeft:"14rem", fontSize:"2rem", marginTop:"3.5rem"}}>Final Amount (Inclusive of all taxes) - ₹1288.00/-</div>
              <div style={{marginLeft:"6.5rem", fontSize:"2rem", marginTop:"2rem", backgroundColor:"#FF6803", padding:"1rem",borderRadius:"10px"}}><button style={{marginLeft:"25rem", textAlign:"center", fontSize:"2rem", backgroundColor:"#FF6803", border:"none", color:"white", fontWeight:"bold"}}>Book Now</button></div>
          </div>
